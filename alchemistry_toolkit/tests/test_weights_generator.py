...
def test_adjust_weights():
    ...
    expected_1 = np.array([ 0.        ,  7.80622153, 14.18712932, 17.3500546 , 19.29906404,       20.69265301, 20.67641217, 18.43027303, 15.59433296])
    expected_2 = np.array([ 0.        ,  7.98738303, 14.86814794, 17.29113768, 18.76978532,       20.08823888, 20.57088274, 19.34025672, 16.66820895])
    expected_3 = np.array([ 0.        ,  7.81886552, 13.88378867, 16.77357959, 18.90675151,       20.36135662, 21.2115675 , 18.51300374, 14.91915581])
    expected_4 = np.array([ 0.        ,  7.8394568 , 13.93409582, 16.80223691, 18.89663727,       20.36083512, 21.14485547, 18.69810792, 15.1645849 ])
    ...
    expected_5 = np.array([ 0.        ,  7.58441458, 13.8391983 , 16.88768357, 18.78953266,       20.59009494, 21.27996925, 17.37912344, 14.87146973])
